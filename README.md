...
```bash
make clean                 # Clean main project
cd test/ && make clean     # Clean tests
```
...
- Make build system
- Python 3.x (optional, for analysis scripts)

## Authors

CS683 Final Project, IIT Bombay

## References

- `An_adaptive_victim_cache_scheme.pdf` - Research paper
- `CS683-2025-CheckPoint-1 (1).pdf` - Project specification
